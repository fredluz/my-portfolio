...
images:
  - "/images/projects/narrative/quest list.png"
  - "/images/projects/narrative/journal.png"
  - "/images/projects/narrative/kanban and tasklist.png"
...
Traditional productivity apps often fail users, especially those with executive function challenges such as ADHD - like me. They demand rigid routines, meticulous manual logging, and, to create emotional engagement, rely on superficial gamification. The friction of *managing* the work becomes a barrier. I needed a tool that integrated seamlessly, understood context, reduced administrative burden, and fostered motivation authentically.

## My Solution: Narrative - Low-Friction Input, Agentic AI, and Narrativization

Narrative is my answer: an AI-powered application minimizing friction by embedding an intelligent agent directly into the workflow. This agent leverages Large Language Models to understand your personal journey and actively assist you, moving beyond simple chatbot paradigms.
...
![Task List Example](/images/projects/narrative/kanban and tasklist.png)
